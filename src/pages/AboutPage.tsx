...
import {CO_OWNER, MANAGERS, MEMBERSHIP, OWNER} from '../lib/content';
    ...
    <section id="csaladfa" className="scroll-mt-24 border-t border-[color:var(--rm-line)] bg-[#070709]">
      <div className="rm-section">
        ...
        <div className="flex flex-col items-center">
          <Reveal className="flex w-full max-w-sm justify-center">
          ...
          <Reveal delay={100} className="flex w-full max-w-sm justify-center">
          ...
          <div className="grid w-full grid-cols-1 justify-items-center gap-3.5 md:grid-cols-2">
            {MANAGERS.map((member, index) => (
              <Reveal key={member.name} delay={index * 100} className="flex w-full max-w-sm justify-center">
                <LeaderCard member={member} emphasis="muted"/>
              </Reveal>
            ))}
          </div>
        </div>
